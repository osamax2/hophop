  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({
        ...
        birthDate: freshProfile.birthDate ? new Date(freshProfile.birthDate).toISOString().split('T')[0] : '',
      ...
      onUpdateUser({
        ...user,
        name: freshProfile.name || formData.name,
        email: freshProfile.email || formData.email,
        phone: freshProfile.phone || formData.phone,
      ...
      const errorMessage = err?.message || err?.error || t.updateError;
      alert(errorMessage);
    } finally {
      setLoading(false);
    }
